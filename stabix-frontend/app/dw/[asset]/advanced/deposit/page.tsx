...
export default function AdvancedDepositPage() {
    ...
    <main className="min-h-screen bg-[#f6f7f9] px-5 pb-10 text-slate-900 dark:bg-[#0b0b0d] dark:text-white">
      <div className="mx-auto w-full max-w-md">
        ...
        <header className="flex items-center gap-3 py-7">
          ...
          <Link
            href={`/dw/${asset.toLowerCase()}/advanced/network?mode=deposit`}
            aria-label="Back"
        ...
        <section className="mt-5 rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#18181b]">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-500 dark:text-slate-400">
            Deposit {asset} directly through the StabiX
            Vault using the {networkName} network.
          </p>
          ...
          <div className="mt-6 rounded-[20px] border border-dashed border-slate-300 bg-slate-50 p-5 dark:border-white/10 dark:bg-[#0f172a]">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Connect your wallet to continue with an
              Advanced deposit.
            </p>
        ...
        <section className="mt-5 rounded-[24px] border border-blue-200 bg-blue-50 p-6 dark:border-blue-500/20 dark:bg-blue-500/5">

          <h2 className="text-lg font-bold text-blue-900 dark:text-blue-300">
            Advanced Mode
          </h2>

          <ul className="mt-3 space-y-2 text-sm leading-6 text-blue-800 dark:text-blue-200/80">
            <li>
              • Your wallet interacts directly with the
              StabiX Vault.
            </li>

            <li>
              • Verify the selected network before
            ...
            <li>
              • Only supported {asset} tokens should be
              deposited.
            </li>
          </ul>
