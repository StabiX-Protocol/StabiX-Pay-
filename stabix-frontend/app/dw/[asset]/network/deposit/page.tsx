      ...
      <div className="mx-auto w-full max-w-md">
        ...
        <section className="rounded-[22px] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#0b1220] dark:shadow-xl">
          ...
          <p className="mt-2 text-[14px] text-slate-500 dark:text-slate-400">
            Send {asset} only on this network.
          </p>
        </section>
        ...
        <section className="mt-5 rounded-[22px] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#0b1220] dark:shadow-xl">
          ...
          <p className="mt-3 text-[14px] leading-6 text-slate-500 dark:text-slate-400">
            Send {asset} only to this address. Your deposit will be
            automatically detected after the blockchain confirmation.
          </p>
        </section>
        ...
        <section className="mt-7 rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-gradient-to-b dark:from-[#101827] dark:to-[#080e19] dark:shadow-2xl">
          ...
          <div className="mt-7">
            ...
            <div className="mt-3 space-y-3 text-[16px] leading-7 text-slate-500 dark:text-slate-400">
              ...
              <p>
                • Send your {asset} from your EOA wallet to the
                deposit address shown above.
              </p>

              <p>
                • Make sure the selected network and asset match
                your actual on-chain transaction.
              </p>
              ...
              <p>
                ...
                tokens to the displayed deposit address.
              </p>

              <p>
                • Your deposit will be detected automatically after
                the required blockchain confirmations.
              </p>

              <p>
                • Sending unsupported assets or using the wrong
